...
plt.errorbar(x+width, averageListTanhTraining, yerr=semAverageListTanhTest, marker='o', label ='Training')
plt.legend()
...
plt.errorbar(x+width, averageListLogisticTraining, yerr=semAverageListLogisticTest, marker='o', label ='Training')
plt.legend()
plt.xticks(x + width / 2, ('10', '20', '30','40','50','60','70','80'))
plt.show()
...
plt.errorbar(x+width, averageListLinealTraining, yerr=semAverageListLinealTest, marker='o', label ='Training')
plt.legend()
plt.xticks(x + width / 2, ('10', '20', '30','40','50','60','70','80'))
plt.show()
